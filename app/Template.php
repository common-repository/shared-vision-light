...
class Template {
  ...
  public static function load_template( string $template_name, array $args = [], string $template_path = '', string $default_path = '' ) {
    ...
    $located = apply_filters( 'sharedvision_get_template', $located, $template_name, $args, $template_path, $default_path );

    do_action( 'shared_vision_before_template_part', $template_name, $template_path, $located, $args );

    include( $located );

    do_action( 'shared_vision_after_template_part', $template_name, $template_path, $located, $args );
  }
  ...
  public static function locate_template( string $template_name, string $template_path = '', string $default_path = '' ) {
    ...
    if ( ! $default_path )
      $default_path = SHARED_VISION_BASE_PATH . '/templates/';
    ...
    return apply_filters( 'sharedvision_locate_template', $template, $template_name, $template_path );
  }

  public static function template_path() {
    return apply_filters( 'sharedvision_template_path', 'sharedvision' );
  }
